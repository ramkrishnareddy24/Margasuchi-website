		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Plan management</div>
					<div class="ps-3">
						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									<form class="row g-3 needs-validation" method="post" action="add_plan.php" enctype="multipart/form-data" novalidate>
...
$date = date('d-m-Y');
 ...
 $duration = mysqli_real_escape_string($con,$_POST['duration']);
  ...
  $sql="INSERT INTO `plan` (`id` ,`name`,`amount` ,`description`,`time`,`duration`)
  VALUES (NULL,'$name','$amount', '$desc','$time','$duration')";
...
$("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
    $("#success-alert").slideUp(500);
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" id="validationCustom02" value="" required name="amount" placeholder="enter Amount">
											<div class="valid-feedback">Looks good!</div>
										</div>
											<div class="col-md-4">
											<label for="validationCustom02" class="form-label">Limit</label>
											<input type="text" class="form-control" id="validationCustom02" value="" required name="time" placeholder="enter time limit">
											<div class="valid-feedback">Looks good!</div>
										</div>
										<div class="col-md-8">
											<label for="validationCustom02" class="form-label">Description</label>
											<textarea type="text" class="form-control" id="validationCustom02" value="" required name="desc" placeholder=""></textarea>
											<div class="valid-feedback">Looks good!</div>
										</div>
										<div class="col-md-4">
											<label for="validationCustom02" class="form-label">Duration</label>
											<input type="text" class="form-control" id="validationCustom02" value="" required name="duration" placeholder="enter Duration">
											<div class="valid-feedback">Looks good!</div>
										</div>
