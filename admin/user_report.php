		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col">
					<br>
						<h6 class="mb-0 text-uppercase">Fetch Users Details</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
			...
			<div class="page-content">
				...
				<div class="row"id="rr">
					<div class="col">
						...
						<h6 class="mb-0 text-uppercase">User Report details</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
				...
				$to=date('d-m-Y', strtotime($to));
							    ...
							    include('config.php');
							$data=mysqli_query($con,"select * from user where date between '$from' AND '$to'") or die("ERROR:".mysqli_error($con));
						...
						?>
									...
									<tr>
										...
										<td><img src="user_adhar/<?php echo $row['adhar']; ?>" style="height:28px; width:28px;" /></td>
									...
									?>
									<script>
									window.location="user_report.php#rr";
									</script>
									<?php
