					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								?>
									<tr>
									    <td><a href="disapp.php?id=<?php echo $id; ?>"><button class="btn btn-danger">DisApprove</button></a></td>
                          ...
                          <td>
						  <a href="disapp.php?deleteval=<?php echo $row['id'];?>" class="delete"><button class="btn btn-danger btn-xs fas fa-trash-alt" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></a></td>																																							
									</tr>
									<?php } ?>
								</tbody>
							</table>
...
if (isset($_GET['id'])) {
  ...
  $sqld = mysqli_query($con, "UPDATE member SET status=0 where id = '$key'");
  echo "<meta http-equiv=\"refresh\" content=\"0;URL=disapp.php\">";
}
?>
<script>
  $(function() {
