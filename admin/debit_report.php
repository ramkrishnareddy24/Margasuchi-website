		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
					<div class="col">
					<br>
						<h6 class="mb-0 text-uppercase">Fetch Debit Details</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
							    <form method="post" action="debit_report.php">
			...
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Debit Report</li>
							</ol>
						</nav>
					</div>
				...
				<div class="row"id="rr">
					<div class="col">
						...
						<h6 class="mb-0 text-uppercase">Debit Report details</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
				...
				$to=date('d-m-Y', strtotime($to));
							    ...
							    include('config.php');
							$data=mysqli_query($con,"select * from payments where date between '$from' AND '$to'") or die("ERROR:".mysqli_error($con));
						...
						?>
									...
									?>
									<script>
									window.location="debit_report.php#rr";
									</script>
									<?php
