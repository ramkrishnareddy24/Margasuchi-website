						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									<form class="row g-3 needs-validation" method="post" action="add_gallery.php" enctype="multipart/form-data" novalidate>
...
$date = date('d-m-Y');
 ...
 $photo = $_FILES['photo']['name'];
  ...
  $sql="INSERT INTO `gallery` (`id` ,`title`,`photo` )
  ...
  if($query){
  	move_uploaded_file($_FILES['photo']['tmp_name'],"gallery_Photos/$photo"); 
  echo '
...
$("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
    $("#success-alert").slideUp(500);
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" id="validationCustom02" value=""  name="title" placeholder="enter Title">
										...
										<div class="col-12">
											<button class="btn btn-primary" name="submit" type="submit">Add Photo</button>
										</div>
									</form>
								</div>
							</div>
