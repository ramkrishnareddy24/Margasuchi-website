						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									<form class="row g-3 needs-validation" method="post" action="add_video.php" enctype="multipart/form-data" novalidate>
...
$date = date('d-m-Y');
 ...
 $link = mysqli_real_escape_string($con,$_POST['link']);
  ...
  $sql="INSERT INTO `video` (`id` ,`title` ,`link`)
...
$("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
    $("#success-alert").slideUp(500);
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" id="validationCustom02" value="" required name="title" placeholder="enter Title">
											<div class="valid-feedback">Looks good!</div>
										</div>
									
										<div class="col-md-4">
											<label for="validationCustom02" class="form-label">Link</label>
											<input type="text" class="form-control" id="validationCustom02" value="" required name="link" placeholder="enter Link">
											<div class="valid-feedback">Looks good!</div>
										</div>
										
										<div class="col-12">
											<button class="btn btn-primary" name="submit" type="submit">Add Video</button>
										</div>
									</form>
								</div>
							</div>
