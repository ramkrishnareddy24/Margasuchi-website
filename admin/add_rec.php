...
<head>
	...
	<title>IFR) – Add Recieved payment</title>
</head>
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Add Recievable Payments</li>
							</ol>
						</nav>
					</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									<form class="row g-3 needs-validation" method="post" action="add_rec.php" enctype="multipart/form-data" novalidate>
...
$member_id = mysqli_real_escape_string($con,$_POST['member_id']);
 $email = mysqli_real_escape_string($con,$_POST['plan']);
 $amount = mysqli_real_escape_string($con,$_POST['amount']);
  ...
  $sql="INSERT INTO `recv_pay` (`member_id`,`id` ,`date`,`plan`,`amount`)
  VALUES ('$member_id',NULL,'$date','$email', '$amount')";
...
$("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
    $("#success-alert").slideUp(500);
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" id="validationCustom02" value="" required name="plan" placeholder="enter plan">
											<div class="valid-feedback">Looks good!</div>
										</div>
										<div class="col-md-4">
