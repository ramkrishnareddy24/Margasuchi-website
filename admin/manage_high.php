					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<?php 
								include('config.php');
								$query=mysqli_query($con,"select * from member where high=1 order by id");
								...
								?>
									<tr>
									    <td><a href="manage_high.php?id=<?php echo $id; ?>"><button class="btn btn-danger">Rm Highlight</button></a></td>
                          ...
                          <td>\
						  <a href="manage_high.php?deleteval=<?php echo $row['id'];?>" class="delete"><button class="btn btn-danger btn-xs fas fa-trash-alt" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></a></td>																																							
									</tr>
									<?php } ?>
								</tbody>
							</table>
...
if (isset($_GET['id'])) {
  ...
  $sqld = mysqli_query($con, "UPDATE member SET high=0 where id = '$key'");
  echo "<meta http-equiv=\"refresh\" content=\"0;URL=manage_high.php\">";
}
?>
<script>
  $(function() {
