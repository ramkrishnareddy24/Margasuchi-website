		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Religion</div>
					<div class="ps-3">
						...
						<div class="card">
							<div class="card-body">
								<div class="p-4 border rounded">
									<form class="row g-3 needs-validation" method="post" action="add_religion.php" enctype="multipart/form-data" novalidate>
...
$date = date('d-m-Y');
 $country = mysqli_real_escape_string($con,$_POST['country']);
  ...
  $sql="INSERT INTO `religion` (`id` ,`religion`)
  VALUES (NULL,'$country')";
...
$("#success-alert").fadeTo(2000, 500).slideUp(500, function(){
    $("#success-alert").slideUp(500);
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" id="validationCustom02" value="" required name="country" placeholder="enter Religion">
											<div class="valid-feedback">Looks good!</div>
										</div>
									
										<div class="col-12">
											<button class="btn btn-primary" name="submit" type="submit">Add Religion</button>
										</div>
									</form>
								</div>
							</div>
